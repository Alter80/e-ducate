        ...
        <div className='backGround'>
            <Container className='allFooter'>
                <Row className='mb-5' md={4}>
                    ...
                    <Col className='footer-margin' >
                        <div className='footer-top'>E-ducate</div>
                        ...
                        <div><FontAwesomeIcon className='footer' icon={faMapMarkerAlt} />Chittagong,Bangladesh</div>
                        <div><FontAwesomeIcon className='footer' icon={faPhoneAlt} />019-28212121</div>
                        <div><FontAwesomeIcon className='footer' icon={faEnvelope} />support@educate.com</div>
                        <div><FontAwesomeIcon className='footer' icon={faClock} />Mon - Sat: 9am - 6pm</div>
                    </Col>
                </Row>

                <small className="text-center mt-3 text-muted">E-ducate® All Rights Reserved,2021</small>
            </Container>
